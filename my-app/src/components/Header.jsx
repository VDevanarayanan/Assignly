  ...
  return (
    <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-slate-200 dark:border-slate-800 px-6 md:px-10 py-3 bg-white dark:bg-slate-900 sticky top-0 z-50">
      <div className="flex flex-col">
        ...
        <p className="text-sm text-slate-500 dark:text-slate-400">Welcome back, {user?.name ? user.name.split(" ")[0] : "User"}!</p>
      </div>
      ...
      <div className="flex items-center gap-4">
        <div className="relative" ref={dropdownRef}>
          ...
          {showNotifs && (
            <div className="absolute right-0 mt-2 w-80 sm:w-96 bg-white dark:bg-slate-900 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-800 overflow-hidden z-50 animate-in fade-in zoom-in-95 duration-200">
